...
: ${AMENT_CURRENT_PREFIX:="/home/jk/ros2_test/src/install/ros2_orb_slam3"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros2_orb_slam3/environment/library_path.sh"
