...
static const _Stereoimage_type_support_symbol_names_t _Stereoimage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_orb_slam3, msg, Stereoimage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_orb_slam3, msg, Stereoimage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_orb_slam3, msg, Stereoimage)() {
  return &::ros2_orb_slam3::msg::rosidl_typesupport_c::Stereoimage_message_type_support_handle;
}
